...
HD_PWD='D:/zybodevelopment/ledblinky/ledblinky.runs/ledbllinky_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ledbllinky_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ledbllinky_processing_system7_0_0.tcl
