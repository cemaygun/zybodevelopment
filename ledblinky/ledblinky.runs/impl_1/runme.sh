...
HD_PWD='D:/zybodevelopment/ledblinky/ledblinky.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ledbllinky_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ledbllinky_wrapper.tcl -notrace
