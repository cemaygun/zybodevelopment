...
HD_PWD='D:/zybodevelopment/ledblinky/ledblinky.runs/ledbllinky_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ledbllinky_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ledbllinky_rst_ps7_0_50M_0.tcl
