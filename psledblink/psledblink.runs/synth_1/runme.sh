...
HD_PWD='D:/zybodevelopment/psledblink/psledblink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log psledblink_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source psledblink_wrapper.tcl
