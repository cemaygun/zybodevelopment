...
HD_PWD='D:/zybodevelopment/psledblink/psledblink.runs/psledblink_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log psledblink_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source psledblink_processing_system7_0_0.tcl
