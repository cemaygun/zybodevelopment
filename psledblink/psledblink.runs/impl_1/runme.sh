...
HD_PWD='D:/zybodevelopment/psledblink/psledblink.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log psledblink_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source psledblink_wrapper.tcl -notrace
