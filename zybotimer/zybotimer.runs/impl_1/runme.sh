...
HD_PWD='D:/zybodevelopment/zybotimer/zybotimer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timerzybo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timerzybo_wrapper.tcl -notrace
