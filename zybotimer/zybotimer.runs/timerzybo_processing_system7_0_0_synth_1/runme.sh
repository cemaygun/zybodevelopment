...
HD_PWD='D:/zybodevelopment/zybotimer/zybotimer.runs/timerzybo_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timerzybo_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timerzybo_processing_system7_0_0.tcl
