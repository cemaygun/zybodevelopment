...
HD_PWD='D:/zybodevelopment/zybotimer/zybotimer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timerzybo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timerzybo_wrapper.tcl
